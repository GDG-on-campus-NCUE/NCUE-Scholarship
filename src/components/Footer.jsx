                    ...
                    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div className="text-center sm:text-left">
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                <Link href="https://stuaffweb.ncue.edu.tw/" className="group flex items-center justify-center sm:justify-start gap-3 text-gray-300 hover:text-white transition-all duration-300 hover:-translate-y-0.5 outline-none focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1E2129] rounded-lg p-1" target="_blank" rel="noopener noreferrer">
                                    <School className="w-5 h-5 flex-shrink-0" />
                                    <span className="footer-link-underline text-sm sm:text-base">彰師 生輔組首頁</span>
                                </Link>
                                <Link href="https://www.facebook.com/ncuestuser" className="group flex items-center justify-center sm:justify-start gap-3 text-gray-300 hover:text-white transition-all duration-300 hover:-translate-y-0.5 outline-none focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1E2129] rounded-lg p-1" target="_blank" rel="noopener noreferrer">
                                ...
                                <Link href="mailto:act5718@gmail.com" className="group flex items-center justify-center sm:justify-start gap-3 text-gray-300 hover:text-white transition-all duration-300 hover:-translate-y-0.5 outline-none focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 focus-visible:ring-offset-[#1E2129] rounded-lg p-1" target="_blank" rel="noopener noreferrer">
